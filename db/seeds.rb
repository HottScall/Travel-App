...
Destination.create(name: "Inpanema", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/beach02.jpg", description: "The beach of Ipanema is known for its elegant development and its social life.", tag_id: t1.id)
Destination.create(name: "7 mile beach club", image:"http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/beach03.jpg", description: "The western coastline contains the island's finest beaches.", tag_id: t1.id)
Destination.create(name: "El Castillo", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/beach04.jpg", description: "An elite destination famous for its white sand beaches", tag_id: t1.id)

t2 = Tag.create(title: "History", image:"http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/history01.jpg")
Destination.create(name: "Machu Picchu", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/history02.jpg", description: "Machu Picchu was built around 1450, at the height of the Inca Empire.", tag_id: t2.id)
Destination.create(name: "Dunrobin Castle", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/history03.jpg", description: "Dunrobin Castle is a stately home in Sutherland. Its origins lie in the Middle Ages.", tag_id: t2.id)
Destination.create(name: "Palace of Westminster", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/history04.jpg", description: "The meeting place of the two houses of the Parliament of the United Kingdom", tag_id: t2.id)
